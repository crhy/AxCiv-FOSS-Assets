...
public class SelectOpponent : BaseDialogHandler
{
    ...
    public override IInterfaceAction HandleDialogResult(DialogResult result, Dictionary<string, ICivDialogHandler> civDialogHandlers, ClassicInterface activeInterface)
    {              
